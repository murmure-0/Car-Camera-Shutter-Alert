...
{
    if (huart->Instance == USART1) {
        printf("[USART1 ERROR] %lu\r\n", huart->ErrorCode);
        HAL_UARTEx_ReceiveToIdle_DMA(&huart1, g_usart1_rx_buf, USART1_RX_BUF_SIZE);
    }
    else if (huart->Instance == USART2) {
        printf("[USART2 ERROR] %lu\r\n", huart->ErrorCode);
        HAL_UARTEx_ReceiveToIdle_DMA(&huart2, g_usart2_rx_buf, USART2_RX_BUF_SIZE);
    }
    else if (huart->Instance == USART3) {
        printf("[USART3 ERROR] %lu\r\n", huart->ErrorCode);
        HAL_UARTEx_ReceiveToIdle_DMA(&huart3, g_usart3_rx_buf, USART3_RX_BUF_SIZE);
    }
}
